...
public class AStarAlgorithm {
    ...
    static Nodes[][] grid = new Nodes[5][5];

    static PriorityQueue<Nodes> open;
    ...
    private static void checkAndUpdateCost(Nodes current, Nodes t, int cost) {
...
//              System.out.println();
    ...
    public static void main(String[] args) throws Exception {
        //4 different unit testing
        test(1, 5, 5, 0, 0, 3, 2, new int[][]{{0, 4}, {3, 1}, {3, 3}});
